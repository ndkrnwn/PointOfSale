<div class="content-wrapper  bg-white fontpoppins">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fas fa-spa mr-3"></i><b>Treatment </b><small><i class="fa  fa-angle-double-right"></i> Edit Treatment</small></h1>
                </div>
                <div class="col-sm-6">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-sm-8">
                                        ...
                                        <input type="number" min="0" class="form-control form-control-sm rounded-0" name="modal" value="<?= $row->modal ?>" required>
                                    </div>
                                    <font style="font-size: 20px" color="red"><i>*</i></font>
                                </div>
                            </div>

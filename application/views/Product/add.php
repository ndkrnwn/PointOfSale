<div class="content-wrapper  bg-white fontpoppins">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class="fab fa-product-hunt mr-3"></i><b>Product </b><small><i class="fa  fa-angle-double-right"></i> Add Product</small></h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container">
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <!-- form start -->
                    <form action="<?= site_url('admin/product/process') ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-sm-8">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text rounded-1"><b>Rp. </b></span>
                                        </div>
                                        <input type="number" min="0" class="form-control rounded-1" name="price" required>
                                    </div>
                                    <font style="font-size: 20px" color="red"><i>*</i></font>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control form-control-sm rounded-1" name="description"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input custom-control-input-danger col-sm-12" type="checkbox" name="is_point_exchange" id="point_toogle" onchange="togglePointRow()">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group row" style=" display:none;" id="pointFieldRow">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" min=0 class="form-control  rounded-1" name="product_point" id="product_point">
                                    </div>
                                    <font style="font-size: 20px" color="red"><i>*</i></font>
                                </div>
                            </div>
